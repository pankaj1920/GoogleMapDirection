...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    LatLng CurrentLatLng,DestinationLatLang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CurrentLatLng = new LatLng(12.9121, 77.6446);
        DestinationLatLang = new LatLng(12.9304, 77.6784);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        String url = getDirectionsUrl(CurrentLatLng, DestinationLatLang);
